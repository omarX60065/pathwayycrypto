                ...
                getPixelForTick: function(t) {
                    ...
                    if (e.isHorizontal()) {
                        var n = (e.width - (e.paddingLeft + e.paddingRight)) / Math.max(e._ticks.length - (i ? 0 : 1), 1)
                          , a = n * t + e.paddingLeft;
                        return i && (a += n / 2),
                        e.left + Math.round(a) + (e.isFullWidth() ? e.margins.left : 0)
                    }
        ...
        48: [function(t, e, i) {
            ...
            e.exports = {
                ...
                initialize: function() {
                    ...
                    t = "@-webkit-keyframes " + M + "{" + i + "}@keyframes " + M + "{" + i + "}." + k + "{-webkit-animation:" + M + " 0.001s;animation:" + M + " 0.001s;}",
                ...
                addEventListener: function(a, t, o) {
                    ...
                    if ("resize" !== t) {
                        ...
                        S(m, t, (v.proxies || (v.proxies = {}))[a.id + "_" + t] = function(t) {
                            var e, i, n;
                            o((i = a,
                            _(C[(e = t).type] || e.type, i, (n = b.getRelativePosition(e, i)).x, n.y, e)))
                        }
                        )
                    } else
                        i = o,
                        ...
                        p = g.resizer = function(t) {
                            ...
                            return S(a, "scroll", r.bind(a, "expand")),
                            S(o, "scroll", r.bind(o, "shrink")),
                            e
                        }((l = !(r = function() {
                            if (g.resizer)
                                return i(_("resize", n))
                ...
                removeEventListener: function(t, e, i) {
                    ...
                    if ("resize" !== e) {
                        ...
                        delete s.resizer,
                        o = (a = n)[x] || {},
                        (r = o.renderProxy) && (b.each(w, function(t) {
                            c(a, t, r)
                        }),
            ...
            e.exports = {
                ...
                afterDatasetsUpdate: function(t, e) {
                    ...
                    for (n = 0; n < u; ++n)
                        ...
                        o.boundary = p(o),
                        o.mapper = (l = void 0,
                        !(l = "dataset") === (s = (r = o).fill) ? null : (isFinite(s) || (l = "boundary"),
                        f[l](r))))
                },
            ...
            e.exports = function(e) {
                ...
                var i = e.LinearScaleBase.extend({
                    ...
                    fit: function() {
                        ...
                        }(this) : (t = Math.min(this.height / 2, this.width / 2),
                        this.drawingArea = Math.round(t),
        ...
        59: [function(t, e, i) {
            ...
            e.exports = function() {
                var t = n.extend({
                    ...
                    determineDataLimits: function() {
                        var t, e, i, n, a, o, r = this, s = r.chart, l = r.options.time, u = l.unit || "day", d = k, c = p, h = [], f = [], g = [];
                        for (t = 0,
                        i = s.data.labels.length; t < i; ++t)
                            g.push(_(s.data.labels[t], r));
                        for (t = 0,
                        i = (s.data.datasets || []).length; t < i; ++t)
                            if (s.isDatasetVisible(t))
                                ...
                                f[t] = [];
                        g.length && (g = v(g).sort(m),
                        d = Math.min(d, g[0]),
                        c = Math.max(c, g[g.length - 1])),
                        h.length && (h = v(h).sort(m),
                        d = Math.min(d, h[0]),
                    ...
                    buildTicks: function() {
                        ...
                        default:
                            v = function(c, h, t, e) {
                                var i, n = e.time, f = n.unit || function(t, e, i, n) {
                                    var a, o, r, s = w.length;
                                    for (a = w.indexOf(t); a < s - 1; ++a)
                                        if (r = (o = M[w[a]]).steps ? o.steps[o.steps.length - 1] : k,
                                        o.common && Math.ceil((i - e) / (r * o.size)) <= n)
                                            return w[a];
                                    return w[s - 1]
                                }(n.minUnit, c, h, t), a = D(f), o = y.valueOrDefault(n.stepSize, n.unitStepSize), r = "week" === f && n.isoWeekday, s = e.ticks.major.enabled, l = M[f], u = x(c), d = x(h), g = [];
                                for (o || (o = function(t, e, i, n) {
                                    var a, o, r, s = h - c, l = M[f], u = l.size, d = l.steps;
                                    if (!d)
                                ...
                                d = d.isoWeekday(r)),
                                u = u.startOf(r ? "day" : f),
                                (d = d.startOf(r ? "day" : f)) < h && d.add(1, f),
                                i = x(u),
                                s && a && !r && !n.round && (i.startOf(a),
                                i.add(~~((u - i) / (l.size * o)) * o, f)); i < d; i.add(o, f))
                                    g.push(+i);
                                return g.push(+i),
                                g
                        ...
                        h._unit = m.unit || function(t, e, i, n) {
                            ...
                            for (a = w.length - 1; a >= w.indexOf(e); a--)
                                if (o = w[a],
                                M[o].common && r.as(o) >= t.length)
                                    return o;
                            return w[e ? w.indexOf(e) : 0]
                        }(b, m.minUnit, h.min, h.max),
                        h._majorUnit = D(h._unit),
                        ...
                        u = a[0],
                        d = (C(n, "time", l, "pos") - C(n, "time", u, "pos")) / 2),
                        s.time.max || (l = a[a.length - 1],
                        u = 1 < a.length ? a[a.length - 2] : o,
                        c = (C(n, "time", l, "pos") - C(n, "time", u, "pos")) / 2)),
                        {
                            left: d,
                            right: c
                        }),
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        return y.isObject(o) && (a = this.getRightValue(o)),
                        n.tooltipFormat ? S(a, n).format(n.tooltipFormat) : "string" == typeof a ? a : S(a, n).format(this._labelFormat)
                    },

...
<head>
		...
		<!-- Title -->
        <title>PATHWAYYCRYPTO - Home</title>
		...
		<?php include('header.php')?>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<h3 class="content-title mb-2">Welcome back <?php echo $_SESSION['fname'] ?>,</h3>
						<div class="d-flex">
							<i class="mdi mdi-home text-muted hover-cursor"></i>
							<p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Dashboard&nbsp;/&nbsp;</p>
							<p class="text-warning mb-0 hover-cursor">Home</p>
						</div>
					</div>
					<!--  -->
				</div>
					...
					<div class="row row-cards">
							...
							<div class="card">
								<div class="card-body">
									<div class="card-box tilebox-one">
										<i class="float-right text-muted"><i class="fas fa-dollar-sign text-warning" aria-hidden="true"></i></i>
										<h6 class="text-drak text-uppercase mt-0">WALLET</h6>
										<h2 class="m-b-20">$<?php 
						...
						<div class="col-sm-12 col-lg-4">
							<div class="card">
								<div class="card-body">
									<div class="card-box tilebox-one">
										<i class="float-right text-muted"><i class="fas fa-sort-amount-up text-pink" aria-hidden="true"></i></i>
										<h6 class="text-drak text-uppercase mt-0">Account Level</h6>
										<h2 class="m-b-20"> <?php echo $_SESSION['level'] ?></h2>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-12 col-lg-4">
							<div class="card">
								<div class="card-body">
									<div class="card-box tilebox-one">
										<i class=" float-right text-muted"><i class="far fa-calendar-alt text-info" aria-hidden="true"></i></i>
										<h6 class="text-drak text-uppercase mt-0">Date of Registration</h6>
										<h2 class="m-b-20"> <?php echo $_SESSION['date'] ?></h2>
									</div>
								</div>
							</div>
						</div>

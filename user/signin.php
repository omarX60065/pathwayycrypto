...
<head>
		...
		<!-- Title -->
        <title>pathwaycrypto - Login</title>
				...
				<div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
					<div class="my-auto authentication-pages">
						<div>
							...
							<br>
							pathwaycrypto - one of the best cryptocurrency brokers on the market for traders all around the world.</p>
				...
				<div class="p-5 wd-md-50p">
                    ...
                    ?>
						<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							...
							<button name="login" class="btn btn-main-primary btn-block">Sign In</button>
						</form>
					</div>

...
<head>
		...
		<!-- Title -->
        <title>PATHWAYYCRYPTO - Approved Withdrawal</title>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div class="d-flex">
							...
							<p class="text-warning mb-0 hover-cursor">Withdrawal History</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Withdrawal History</h4>
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-20p border-bottom-0">Wallet</th>
												<th class="wd-15p border-bottom-0">Date</th>
												<th class="wd-15p border-bottom-0">Status</th>
											</tr>
											<?php
                                            $sql = "SELECT * from approved_withdrawal WHERE userid = $userid";
										...
										<tbody>
											<tr>
	                                                ...
	                                                <td><?php echo $rows['date']; ?></td>
	                                               	<td><a style="color:white;" class ="btn btn-success"><i class="far fa-check-circle"></i> APPROVED</a></td>
												</tr>
												<?php
                                            }
                                            ?>

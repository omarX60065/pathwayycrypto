!(function (e) {
    ...
    1: function (e, a, n) {
        ...
        a.a = {
            ...
            dzd: { id: 3537, name: "Algerian Dinar", symbol: "dzd", token: "Ø¯.Ø¬", space: "" },
            ars: { id: 2821, name: "Argentine Peso", symbol: "ars", token: "$", space: "" },
            amd: { id: 3527, name: "Armenian Dram", symbol: "amd", token: "Ö", space: "" },
            aud: { id: 2782, name: "Australian Dollar", symbol: "aud", token: "$", space: "" },
            azn: { id: 3528, name: "Azerbaijani Manat", symbol: "azn", token: "â‚¼", space: "" },
            bhd: { id: 3531, name: "Bahraini Dinar", symbol: "bhd", token: ".Ø¯.Ø¨", space: "" },
            bdt: { id: 3530, name: "Bangladeshi Taka", symbol: "bdt", token: "à§³", space: "" },
            ...
            bgn: { id: 2814, name: "Bulgarian Lev", symbol: "bgn", token: "Ð»Ð²", space: "" },
            khr: { id: 3549, name: "Cambodian Riel", symbol: "khr", token: "áŸ›", space: "" },
            cad: { id: 2784, name: "Canadian Dollar", symbol: "cad", token: "$", space: "" },
            clp: { id: 2786, name: "Chilean Peso", symbol: "clp", token: "$", space: "" },
            cny: { id: 2787, name: "Chinese Yuan", symbol: "cny", token: "Â¥", space: "" },
            cop: { id: 2820, name: "Colombian Peso", symbol: "cop", token: "$", space: "" },
            crc: { id: 3534, name: "Costa Rican ColÃ³n", symbol: "crc", token: "â‚¡", space: "" },
            hrk: { id: 2815, name: "Croatian Kuna", symbol: "hrk", token: "kn", space: "" },
            cup: { id: 3535, name: "Cuban Peso", symbol: "cup", token: "$", space: "" },
            czk: { id: 2788, name: "Czech Koruna", symbol: "czk", token: "KÄ", space: "" },
            dkk: { id: 2789, name: "Danish Krone", symbol: "dkk", token: "kr", space: ". " },
            dop: { id: 3536, name: "Dominican Peso", symbol: "dop", token: "$", space: "" },
            egp: { id: 3538, name: "Egyptian Pound", symbol: "egp", token: "Â£", space: "" },
            eur: { id: 2790, name: "Euro", symbol: "eur", token: "â‚¬", space: "" },
            gel: { id: 3539, name: "Georgian Lari", symbol: "gel", token: "â‚¾", space: "" },
            ghs: { id: 3540, name: "Ghanaian Cedi", symbol: "ghs", token: "â‚µ", space: "" },
            ...
            isk: { id: 2818, name: "Icelandic KrÃ³na", symbol: "isk", token: "kr", space: "" },
            inr: { id: 2796, name: "Indian Rupee", symbol: "inr", token: "â‚¹", space: "" },
            idr: { id: 2794, name: "Indonesian Rupiah", symbol: "idr", token: "Rp", space: " " },
            irr: { id: 3544, name: "Iranian Rial", symbol: "irr", token: "ï·¼", space: "" },
            iqd: { id: 3543, name: "Iraqi Dinar", symbol: "iqd", token: "Ø¹.Ø¯", space: "" },
            ils: { id: 2795, name: "Israeli New Shekel", symbol: "ils", token: "â‚ª", space: "" },
            jmd: { id: 3545, name: "Jamaican Dollar", symbol: "jmd", token: "$", space: "" },
            jpy: { id: 2797, name: "Japanese Yen", symbol: "jpy", token: "Â¥", space: "" },
            jod: { id: 3546, name: "Jordanian Dinar", symbol: "jod", token: "Ø¯.Ø§", space: "" },
            kzt: { id: 3551, name: "Kazakhstani Tenge", symbol: "kzt", token: "â‚¸", space: "" },
            kes: { id: 3547, name: "Kenyan Shilling", symbol: "kes", token: "Sh", space: "" },
            kwd: { id: 3550, name: "Kuwaiti Dinar", symbol: "kwd", token: "Ø¯.Ùƒ", space: "" },
            kgs: { id: 3548, name: "Kyrgystani Som", symbol: "kgs", token: "Ñ", space: "" },
            lbp: { id: 3552, name: "Lebanese Pound", symbol: "lbp", token: "Ù„.Ù„", space: "" },
            mkd: { id: 3556, name: "Macedonian Denar", symbol: "mkd", token: "Ð´ÐµÐ½", space: "" },
            myr: { id: 2800, name: "Malaysian Ringgit", symbol: "myr", token: "RM", space: "" },
            mur: { id: 2816, name: "Mauritian Rupee", symbol: "mur", token: "â‚¨", space: "" },
            mxn: { id: 2799, name: "Mexican Peso", symbol: "mxn", token: "$", space: "" },
            mdl: { id: 3555, name: "Moldovan Leu", symbol: "mdl", token: "L", space: "" },
            mnt: { id: 3558, name: "Mongolian Tugrik", symbol: "mnt", token: "â‚®", space: "" },
            mad: { id: 3554, name: "Moroccan Dirham", symbol: "mad", token: "Ø¯.Ù….", space: "" },
            mmk: { id: 3557, name: "Myanma Kyat", symbol: "mmk", token: "Ks", space: "" },
            nad: { id: 3559, name: "Namibian Dollar", symbol: "nad", token: "$", space: "" },
            npr: { id: 3561, name: "Nepalese Rupee", symbol: "npr", token: "â‚¨", space: "" },
            twd: { id: 2811, name: "New Taiwan Dollar", symbol: "twd", token: "NT$", space: "" },
            nzd: { id: 2802, name: "New Zealand Dollar", symbol: "nzd", token: "$", space: "" },
            nio: { id: 3560, name: "Nicaraguan CÃ³rdoba", symbol: "nio", token: "C$", space: "" },
            ngn: { id: 2819, name: "Nigerian Naira", symbol: "ngn", token: "â‚¦", space: "" },
            nok: { id: 2801, name: "Norwegian Krone", symbol: "nok", token: "kr", space: " " },
            omr: { id: 3562, name: "Omani Rial", symbol: "omr", token: "Ø±.Ø¹.", space: "" },
            pkr: { id: 2804, name: "Pakistani Rupee", symbol: "pkr", token: "â‚¨", space: " " },
            pab: { id: 3563, name: "Panamanian Balboa", symbol: "pab", token: "B/.", space: "" },
            pen: { id: 2822, name: "Peruvian Sol", symbol: "pen", token: "S/.", space: "" },
            php: { id: 2803, name: "Philippine Peso", symbol: "php", token: "â‚±", space: "" },
            pln: { id: 2805, name: "Polish ZÅ‚oty", symbol: "pln", token: "zÅ‚", space: "" },
            gbp: { id: 2791, name: "Pound Sterling", symbol: "gbp", token: "Â£", space: "" },
            qar: { id: 3564, name: "Qatari Rial", symbol: "qar", token: "Ø±.Ù‚", space: "" },
            ron: { id: 2817, name: "Romanian Leu", symbol: "ron", token: "lei", space: "" },
            rub: { id: 2806, name: "Russian Ruble", symbol: "rub", token: "â‚½", space: "" },
            sar: { id: 3566, name: "Saudi Riyal", symbol: "sar", token: "Ø±.Ø³", space: "" },
            rsd: { id: 3565, name: "Serbian Dinar", symbol: "rsd", token: "Ð´Ð¸Ð½.", space: "" },
            sgd: { id: 2808, name: "Singapore Dollar", symbol: "sgd", token: "S$", space: "" },
            zar: { id: 2812, name: "South African Rand", symbol: "zar", token: "R", space: " " },
            krw: { id: 2798, name: "South Korean Won", symbol: "krw", token: "â‚©", space: "" },
            ssp: { id: 3567, name: "South Sudanese Pound", symbol: "ssp", token: "Â£", space: "" },
            ...
            thb: { id: 2809, name: "Thai Baht", symbol: "thb", token: "à¸¿", space: "" },
            ttd: { id: 3569, name: "Trinidad and Tobago Dollar", symbol: "ttd", token: "$", space: "" },
            tnd: { id: 3568, name: "Tunisian Dinar", symbol: "tnd", token: "Ø¯.Øª", space: "" },
            try: { id: 2810, name: "Turkish Lira", symbol: "try", token: "â‚º", space: "" },
            ugx: { id: 3570, name: "Ugandan Shilling", symbol: "ugx", token: "Sh", space: "" },
            uah: { id: 2824, name: "Ukrainian Hryvnia", symbol: "uah", token: "â‚´", space: "" },
            aed: { id: 2813, name: "United Arab Emirates Dirham", symbol: "aed", token: "Ø¯.Ø¥", space: "" },
            uyu: { id: 3571, name: "Uruguayan Peso", symbol: "uyu", token: "$", space: "" },
            uzs: { id: 3572, name: "Uzbekistan Som", symbol: "uzs", token: "so'm", space: "" },
            vnd: { id: 2823, name: "Vietnamese Dong", symbol: "vnd", token: "â‚«", space: "" },
        };
    },
    36: function (e, a) {
        function n(a) {
            ...
            function s() {
                ...
                function c(e, a, n, t, o, i, c, d, p, u, b, y, k, g, h, f, v, x, w, S) {
                    ...
                    var C = g ? "(" + t + ")" : "",
                        ...
                        j = b ? r(b, 2) : "?",
                        _ = y ? r(y, 2) : "?",
                        R = "zh" == S ? "ç”±CoinMarketCapè£å¹¸å‘ˆçŽ°" : "Powered by Pathway Crypto ",
                        M = "";

...
<head>
		...
		<!-- Title -->
        <title>PATHWAYYCRYPTO - Earnings</title>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div class="d-flex">
							...
							<p class="text-warning mb-0 hover-cursor">Earning History</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Earning History</h4>
								...
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										<thead>
											...
											<?php
                                            $sql = "SELECT * from earnings WHERE userid = $userid";

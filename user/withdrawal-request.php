...
$status = 0;
  ...
  $sql = "INSERT INTO withdrawals (userid, amount, email, method, wallet, date, status)
  VALUES ('$userid', '$amount', '$email','$method', '$wallet', now(), '$status' )";
...
<head>
		...
		<!-- Title -->
        <title>PATHWAYYCRYPTO - Withdrawal Request</title>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div class="d-flex">
							...
							<p class="text-warning mb-0 hover-cursor">Withdrawal Request</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Withdrawal Request</h4>
									<i class="mdi mdi-dots-horizontal text-gray"></i>
								</div>
								<p class="tx-12 tx-gray-500 mb-2">Has your trading cycle ended? Initiate your withdrawal process now.</p>
							</div>
							<div class="card-body">
										...
										<div class="col-sm-6">
											<div class="form-group">
												<label class="form-label">Amount</label>
													<input class="form-control" placeholder="Enter Amount" required name="amount" type="number">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												<label class="form-label">Email</label>
													<input class="form-control" placeholder="Enter Your Email" required name="email" type="email">
											</div>
										</div>
									</div>
									<div class="row row-sm">
										<div class="col-sm-6">
											<div class="form-group">
												<label class="form-label">Recipient Wallet </label>
													<input class="form-control" placeholder="Enter Wallet" required name="wallet" type="text">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												<label class="form-label">Percentage </label>
													<input class="form-control" disabled placeholder="10%" type="text">
											</div>
										</div>
									</div>

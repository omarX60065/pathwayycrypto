...
<head>
		...
		<!-- Title -->
        <title>PATHWAYYCRYPTO - Bank Withdrawal</title>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div class="d-flex">
							...
							<p class="text-warning mb-0 hover-cursor">Bank Withdrawal</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-lg-6 col-xl-3">
						<div class="panel price panel-color">
							<div class="panel-heading bg-warning p-0 text-center">
								<?php
                                            $sql = "SELECT * from bank_names where userid = 1;";
							...
							<div class="panel-footer text-center">
								...
								<a class="btn btn-warning"  href="bkash.php">Withdraw</a>
							<?php }?>
					...
					<div class="col-xs-6 col-sm-6 col-lg-6 col-xl-3">
						<div class="panel price panel-color">
							<div class="panel-heading bg-warning  p-0 text-center">
								<?php
                                            $sql = "SELECT * from bank_names where userid = 2;";
                                            $result = $conn->query($sql);
                                            while ($rows=mysqli_fetch_assoc($result)){
							...
							<div class="panel-footer text-center">
								<a class="btn btn-warning" href="nordea.php">Withdraw</a>
							</div>
								<?php }?>
						</div>
					</div><!-- COL-END -->
					<div class="col-xs-6 col-sm-6 col-lg-6 col-xl-3">
						<div class="panel price panel-color">
							<?php
                                            $sql = "SELECT * from bank_names where userid = 3;";
                                            $result = $conn->query($sql);
                                            while ($rows=mysqli_fetch_assoc($result)){
							...
							<div class="panel-footer text-center">
								<a class="btn btn-warning" href="dutch.php">Withdraw</a>
							</div>
							<?php }?>
						</div>
					</div><!-- COL-END -->
					<div class="col-xs-6 col-sm-6 col-lg-6 col-xl-3">
						<div class="panel price panel-color">
							<?php
                                            $sql = "SELECT * from bank_names where userid = 4;";
                                            $result = $conn->query($sql);
                                            while ($rows=mysqli_fetch_assoc($result)){
							...
							<div class="panel-footer text-center">
								<a class="btn btn-warning" href="csb.php">Withdraw</a>
							</div>
							<?php }?>
						</div>
					</div><!-- COL-END -->

...
<head>
		...
		<!-- Title -->
        <title>PATHWAYYCRYPTO - Reset Code</title>
						...
						<div class="main-signin-header">
							...
							<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
								<div class="form-group">
										<input class="form-control" name="otp" placeholder="Enter Code" type="text">
								</div>
								<button  name="check-reset-otp" class="btn btn-main-primary btn-block">Continue</button>
							</form>
						</div>
					</div>
				</div>

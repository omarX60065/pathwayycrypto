...
<head>
      ...
      <title>PATHWAYYCRYPTO - Admin- Update Customers</title>
                                                      ...
                                                      <div class="row">
                                                            <div class="col-sm-4">
                                                                  ...
                                                                  <div class="form-group">
                                                                        ...
                                                                        <input type="email" name="email" class="form-control" required="email" value="<?php echo $rows['email']; ?>">
                                                                  </div>
                                                                  <div class="form-group">
                                                                        <label for="email2">Phone</label>
                                                                        <input type="number" name="phone" class="form-control" required="phone" value="<?php echo $rows['phone']; ?>">
                                                                  </div>
                                                                  <div class="form-group">
                                                                        <label for="phone">Balance</label>
                                                                        <input type="number" class="form-control" name="balance" required="balance" value="<?php echo $rows['balance']; ?>">
                                                                  </div>
                                                                  <div class="form-group">
                                                                        <label for="phone">Account Level</label>
                                                                        <input type="text" class="form-control" name="level" required="balance" value="<?php echo $rows['acc_level']; ?>">
                                                                  </div>
                                                                  <div class="form-group">
                                                                        <label for="city">Password</label>
                                                                        <input type="text" class="form-control" name="password" required="password" value="<?php echo $rows['password']; ?>">
                                                                  </div>
                                                                  <div class="form-group">

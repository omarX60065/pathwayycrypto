...
<head>
	...
	<title>PATHWAYYCRYPTO - Admin- Activate Customers</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Activate Customers</h4>
									...
									<div class="table-responsive">
										<table id="basic-datatables" class="display table table-striped table-hover" >
											...
											<tbody>
                                                ...
                                                <td>
                                                    <a href="activating.php?userid= <?php echo $rows["userid"]; ?>"
                                                        class ="btn btn-success"><i class="fas fa-user-check"></i> Activate
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="deactivating.php?userid= <?php echo $rows["userid"]; ?>"
                                                        class ="btn btn-danger"><i class="fas fa-user-times"></i> Deactivate
                                                    </a>
                                                </td>
												</tr>
												<?php

...
<head>
  ...
  <title>eCryptoandtrade - Admin- Deposit Customers</title>
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $rows['userid']?></td>
                                                ...
                                                <td>
                                                    <a href="earning.php?userid= <?php echo $rows["userid"]; ?>"
                                                        class ="btn btn-warning"><i class="fas fa-credit-card"></i> CREDIT
                                                    </a>
                                                </td>
                        </tr>
                        <?php

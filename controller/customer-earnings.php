...
<head>
  ...
  <title>PATHWAYYCRYPTO - Admin- Customer Earnings</title>
      ...
      <div class="content">
        <div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">View Customer Earnings</h4>
                    ...
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                              <a href="balance.php?userid= <?php echo $rows["userid"]; ?>"
                                  class ="btn btn-warning"><i class="fas fa-search"></i> VIEW
                              </a>
                          </td>
                        </tr>
                        <?php
